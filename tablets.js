const API_URL = 'https://xf9zlapr5e.execute-api.af-south-1.amazonaws.com/tablets';
...
const mockProducts = [
    {
        ...
        imageUrl: "https://images.samsung.com/is/image/samsung/p6pim/za/sm-x910nzaeeue/gallery/za-galaxy-tab-s9-ultra-wifi-x910-sm-x910nzaeeue-536818617",
        offers: [
    ...
    },
    {
        ...
        brand: "Apple",
        model: "iPad Pro 12.9",
        imageUrl: "https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/ipad-pro-finish-select-202210-12-9inch-space-gray-wifi?wid=5120&hei=2880&fmt=p-jpg&qlt=80&.v=1664411207154",
        offers: [
            { price: 21999, originalPrice: 24999 },
            { price: 22499, originalPrice: 24999 }
        ],
        specs: {
            Performance: {
                Ram: "8GB",
    ...
    },
    {
        ...
        brand: "Lenovo",
        model: "Tab P12 Pro",
        imageUrl: "https://p2-ofp.static.pub/fes/cms/2021/08/25/ql9z0kc9yvlvs9ixq8ztlsv9t8f3i9537.png",
        offers: [
...
function createProductCard(product, wishlistIds) {
    ...
    card.innerHTML = `
        <a href="tablets-product.html?id=${product.product_id}" class="product-link">
    ...
    compareButton.addEventListener('click', function () {
        window.location.href = `tablets-info.html?id=${product.product_id}`;
    });
            ...
            try {
                if (isCurrentlyInWishlist) {
                    ...
                    const wishlistItem = {
                        ...
                        url: `tablets-product.html?id=${product.product_id}`
                    };
...
// Add CSS for price alert modal and other styles
